...
import remover from "@/public/remover.png";
import { Button } from "./ui/button";
import { UploadButton } from "@/util/uploadthing";

const AdvancedSplitter = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full p-5 px-10 my-32 text-white tracking-tighter">
      <div className="flex flex-col items-center justify-center gap-10 text-center">
        ...
        <h1 className="text-3xl md:text-5xl font-bold">Advanced Splitter</h1>
        <p className="max-w-md md:max-w-2xl">
          Extract vocal, accompaniment and various instruments from any audio
          and video
        </p>
        <Image src={remover} alt="remover" className="max-w-full" />
      ...
      <div id="work" className="my-40 border-t-2 border-[#1b586c]">
        <div className="flex flex-col gap-5 items-start justify-start mt-10">
          <h1 className="text-white tracking-tighter text-xl md:text-3xl">
            AI-Powered Advanced Music Separator
          </h1>
...
export default AdvancedSplitter;
